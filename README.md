...
- Imports Canvas Calendar Feeds, iCal/ICS calendar links, or pasted calendar exports without provider OAuth setup.
- Keeps Canvas OAuth sign-in optional for future app-owner setup.
...
Calendar import works without OAuth through a Canvas Calendar Feed, iCal/ICS URL, `webcal://` URL, or pasted `.ics` export on the Connections page. Public GitHub sync also works without OAuth by entering a GitHub username.

Provider sign-in for private repositories, direct Canvas API sync, Google Calendar, and Microsoft 365 requires OAuth app credentials:
